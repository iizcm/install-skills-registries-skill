...
[![Category: Development](https://img.shields.io/badge/Category-Development-purple)](#)

| Field | Value |
| --- | --- |
| **Name** | `install-skills-registries-skill` |
...
cp -r software-development/install-skills-registries ~/.hermes/skills/software-development/install-skills-registries/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/install-skills-registries-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/install-skills-registries-skill.git ~/.hermes/skills/software-development/install-skills-registries/
```
...
```text
skill_view(name="software-development/install-skills-registries")
```
...
```text
Use the install skills registries skill to <describe your specific task here>
```
...
```text
Gunakan skill install skills registries untuk <deskripsikan tugas spesifik Anda di sini>
```
